...
lhs:  
  ...
  | e=lhs LBRACKET i=exp RBRACKET
                        { loc $startpos $endpos @@ Index (loc $startpos $endpos @@ Lhs e, i) }
  | e=exp LPAREN es=separated_list(COMMA, exp) RPAREN  LBRACKET i=exp RBRACKET
                        { loc $startpos $endpos @@ Index (loc $startpos $endpos @@ Call (e,es), i) }
